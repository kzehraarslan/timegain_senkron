...
function Dashboard() {
  ...
  const menuItems = [
    { icon: <FaHome style={styles.icon} title="Ana Sayfa" />, title: 'Ana Sayfa' },
    { icon: <MdOutlineNoteAdd style={styles.icon} onClick={handleNoteEditorPage} title="Not Ekle" />, title: 'Not Ekle' },
    { icon: <FaCalendarAlt style={styles.icon} title="Takvim" />, title: 'Takvim' },
    { icon: <FaChalkboardTeacher style={styles.icon} title="Eğitimler" />, title: 'Eğitimler' },
